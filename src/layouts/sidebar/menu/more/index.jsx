      ...
      <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-black shadow-box rounded-xl overflow-hidden ">
        <button className="px-4 h-14 w-full transition-colors inline-flex items-center gap-5 hover:bg-[#eff3f41a]">
          <div className="p-3 rounded-full transition-colors inline-flex items-center gap-5  group-hover:bg-[#eff3f41a]">
            ...
            <div className="pr-4 text-xl">Bookmarks</div>
          </div>
        </button>
        ...
        <button className="px-4 h-14 w-full transition-colors inline-flex items-center gap-5 hover:bg-[#eff3f41a]">
          <div className="p-3 rounded-full transition-colors inline-flex items-center gap-5  group-hover:bg-[#eff3f41a]">
            ...
            <div className="pr-4 text-xl">Monetization</div>
          </div>
        </button>

        <Disclosure>
          <Disclosure.Button className="px-4 font-bold flex justify-between w-full items-center h-[52px] transition-colors hover:bg-[#eff3f41a] ">
            Creator Studio
            <svg
              viewBox="0 0 24 24"
              width={18.75}
          ...
          <Disclosure.Panel className="text-gray-500">
            <Link
              to={"/"}
              className="flex items-center px-3 h-11 gap-3 text-[15px] font-medium text-white"
            >
              <svg
                viewBox="0 0 24 24"
                width={18.75}
